...
async function loadAdminCatalog() {
    try {
        const response = await fetch("https://backend-paulo-renato-toalhas.onrender.com/api/toalhas");
...
async function deleteProduct(productId) {
    ...
    try {
        const response = await fetch(`https://backend-paulo-renato-toalhas.onrender.com/api/toalhas/${productId}`, {
            method: "DELETE"
        });
