...
async function loadAdminCatalog() {
    try {
        const response = await fetch("https://backend-paulo-renato.onrender.com/api/produtos");
...
async function deleteProduct(productId) {
    ...
    try {
        const response = await fetch(`https://backend-paulo-renato.onrender.com/api/produtos/${productId}`, {
            method: "DELETE"
        });
