...
signUpForm.addEventListener("submit", async (e) => {
    ...
    try {
        const response = await fetch("https://backend-paulo-renato.onrender.com/api/register", {
            method: "POST",
...
try {
    const response = await fetch("https://backend-paulo-renato.onrender.com/api/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
